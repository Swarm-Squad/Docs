...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      {
        text: 'Reference',
        items: [{ text: 'Doc Typography', link: '/reference/typography' }]
      }
    ],
